...
int seleccionarCliente(eCliente cliente[], int lenClien)
{
    int idMenu = -1;
    int contClien = 0;
    printf("\nClientes: \n");
    ...
    {
        idMenu = getValidInt("\nSeleccione ID de cliente: ", "ID no valida.");
    }
    return idMenu;
}

void cargarCliente(eCliente cliente[], int tamCliente, int idCliente, char apellido[], char nombre[])
{
